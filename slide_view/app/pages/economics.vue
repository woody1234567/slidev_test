...
const presentations = [
  {
    title: 'Chap3',
    description: 'Fundamental principles of economics and market dynamics.',
    link: '/Economics/chap3',
    icon: 'i-heroicons-banknotes'
  },
  {
    title: 'Chap5',
    description: 'Fundamental principles of economics and market dynamics.',
    link: '/Economics/chap5',
    icon: 'i-heroicons-banknotes'
  },
  {
    title: 'Chap6',
    description: 'Fundamental principles of economics and market dynamics.',
    link: '/Economics/chap6',
    icon: 'i-heroicons-banknotes'
  },
  {
    title: 'Chap7',
    description: 'Fundamental principles of economics and market dynamics.',
    link: '/Economics/chap7',
    icon: 'i-heroicons-banknotes'
  },
  {
    title: 'Chap18',
    description: 'Fundamental principles of economics and market dynamics.',
    link: '/Economics/chap18',
    icon: 'i-heroicons-banknotes'
  },
]

useHead({
  title: 'Economics - Slide Hub',
  meta: [
    { name: 'description', content: 'Explore Economics presentations and educational materials.' }
  ]
})
</script>
  ...
  <UContainer class="py-12">
    <div class="mb-12 text-center">
      ...
      <p class="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
        A collection of interactive presentations covering micro and macro economic concepts.
      </p>
    </div>
